...
public class SeasonSelectorTest extends FileSystemEnvironment {

    private SeasonSelector selector;

    @Before
    public void setUp() throws Exception {
        Arguments args = ArgsParser.parse(arg("Scrubs", "s01"));
        TVPath tvPath = new StandardTVLibrary(MockFileSystem.getSourceFolders());
        selector = new SeasonSelector(tvPath);
    ...
    public void getSelector() {
        assertTrue("s01".matches(selector.getSelector()));
    }
    ...
    public void findMatches() throws IOException {
        ...
        List<EpisodeMatch> expectedMatches = MockFileSystem.getFullSeasonEpisodeMatches("Scrubs", 1, 1);
