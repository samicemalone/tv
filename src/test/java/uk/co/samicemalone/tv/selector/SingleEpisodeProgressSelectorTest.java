...
public class SingleEpisodeProgressSelectorTest extends FileSystemEnvironment {

    private SingleEpisodeProgressSelector selector;

    @Before
    public void setUp() throws Exception {
        Arguments args = ArgsParser.parse(arg("Scrubs", "s01e05"));
        TVPath tvPath = new StandardTVLibrary(MockFileSystem.getSourceFolders());
        selector = new SingleEpisodeProgressSelector(tvPath, null);
    ...
    public void getSelector() {
        assertTrue("s01e05".matches(selector.getSelector()));
    }
    ...
    public void findMatches() throws IOException {
        ...
        EpisodeMatch expectedMatch = MockFileSystem.getEpisodeMatch("Scrubs", 1, episodeNo);
